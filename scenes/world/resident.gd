...
## native builds restored the same property correctly.
@export var opening_points: Array[Vector2] = []
@export var restored_points: Array[Vector2] = []
@export var stage_one_points: Array[Vector2] = []
@export var settled_objective_id: String = ""
@export var settled_points: Array[Vector2] = []
@export var post_chapter_points: Array[Vector2] = []
...
func _apply_story_state(snap_to_route: bool) -> void:
	...
	var next_points: Array[Vector2] = selected[1]
